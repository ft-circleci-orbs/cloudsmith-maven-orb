...
CLOUDSMITH_MAVEN_REPOSITORY_UNSTABLE_URL="https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY_SNAPSHOTS/maven/"
...
echo "CLOUDSMITH_MAVEN_REPOSITORY_UNSTABLE_URL=https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY_SNAPSHOTS/maven/"
