...
then
  echo "Unable to set environment variables for maven. Env var CLOUDSMITH_REPOSITORY_SNAPSHOTS is not defined."
  exit 1
fi
...
CLOUDSMITH_MAVEN_REPOSITORY_SNAPSHOT_URL="https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY_SNAPSHOTS/maven/"
...
echo "export CLOUDSMITH_REPOSITORY_SNAPSHOTS=\"$CLOUDSMITH_REPOSITORY_SNAPSHOTS\"" >> "$BASH_ENV"
echo "export CLOUDSMITH_MAVEN_REPOSITORY_URL=\"$CLOUDSMITH_MAVEN_REPOSITORY_URL\"" >> "$BASH_ENV"
echo "export CLOUDSMITH_MAVEN_REPOSITORY_SNAPSHOT_URL=\"$CLOUDSMITH_MAVEN_REPOSITORY_SNAPSHOT_URL\"" >> "$BASH_ENV"
...
echo "CLOUDSMITH_MAVEN_REPOSITORY_SNAPSHOT_URL=https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY_SNAPSHOTS/maven/"
