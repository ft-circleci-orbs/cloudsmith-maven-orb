...
CLOUDSMITH_MAVEN_REPOSITORY="https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY/maven/"
CLOUDSMITH_MAVEN_TOKEN="$CLOUDSMITH_OIDC_TOKEN"
REPO_ID="$CLOUDSMITH_ORGANISATION-$CLOUDSMITH_REPOSITORY"
...
echo "export REPO_ID=\"$REPO_ID\"" >> "$BASH_ENV"

echo "The following environment variables have been exported. Note, the OIDC token has been masked below."
echo ""
echo "CLOUDSMITH_MAVEN_REPOSITORY=https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/basic/$CLOUDSMITH_REPOSITORY/maven/"
