...
CLOUDSMITH_MAVEN_REGISTRY="https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/maven/"
CLOUDSMITH_MAVEN_TOKEN=$CLOUDSMITH_OIDC_TOKEN

echo "export CLOUDSMITH_MAVEN_REGISTRY=\"$CLOUDSMITH_MAVEN_REGISTRY\"" >> "$BASH_ENV"
...
echo ""
echo "CLOUDSMITH_MAVEN_REGISTRY=https://$CLOUDSMITH_MAVEN_DOWNLOADS_DOMAIN/$CLOUDSMITH_REPOSITORY/"
